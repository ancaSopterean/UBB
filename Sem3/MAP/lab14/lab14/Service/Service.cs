...
public class Service
{
    ...
    public Service(DocumentsFileRepository documentsFileRepository,
        BillsFileRepository billsFileRepository, AcquisitionFileRepository acquisitionFileRepository)
    {
        DocumentsRepository = documentsFileRepository;
        BillsRepository = billsFileRepository;
        AcquisitionsRepository = acquisitionFileRepository;
    }
    ...
    public List<BillDTO> GetBillsDueToday()
    {
    ...
    public List<Bill> GetInitializedBillsWithAcquisitions()
    {
        ...
        return bills.GroupJoin(
            ...
            (bill, acquisitionGroup) => new Bill
            {
                Id=bill.Id,
                Name=bill.Name,
                Acquisitions = acquisitionGroup.ToList(),
                Category = bill.Category,
                DueDate = bill.DueDate,
                IssueDate = bill.IssueDate
            }).ToList();
